...
;;
;;
;; name: color-theme-charcoal-black
;; date: Mon Nov 01 2010 11:31:48 GMT-0400 (EDT)
;;
;;
;; To use this theme save this code into a
;; file named color-theme-charcoal-black.el and place it
;; in a directory in your load-path
;;
;;    (require 'color-theme-charcoal-black)
...
(defun color-theme-charcoal-black ()
  "Generated with http://color-theme-select.heroku.com/ on Mon Nov 01 2010 11:31:48 GMT-0400 (EDT)  
Color theme by Lars Chr. Hausmann, created 2003-03-24."
  ...
  (color-theme-install
    '(color-theme-charcoal-black
      ...
      (default  ((t (:background "Grey15" :foreground "Grey" :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))
      ...
      (cperl-hash-face  ((t (:italic t :foreground "beige" :slant italic :weight bold))))
      ...
      (gnus-header-newsgroups-face  ((t (:italic t :foreground "MediumAquamarine" :slant italic :weight bold))))
      ...
      (gnus-summary-high-unread-face  ((t (:italic t :foreground "beige" :slant italic :weight bold))))
      ...
      (header-line  ((t (:box ( :line-width -1 :style released-button ) :background "grey20" :foreground "grey90"))))
      ...
      (message-header-newsgroups-face  ((t (:italic t :foreground "MediumAquamarine" :slant italic :weight bold))))
...
(provide 'color-theme-charcoal-black)